...
public class BusquedaArchivosDialog extends javax.swing.JDialog {
    ...
    public final String zipLabel = " archivos zip protegidos";
    public final String rarLabel = " archivos rar protegidos";
    public final String invalidosLabel = " archivos invalidos";
    private final String otrosArchivosLabel = "otros archivos ";
    ...
    /*
        Verifica los archivos que han sido encontrados para posteriormente verificarlos
        -Verifica si tiene contraseña y si es valido
    */
    public void verificarArchivos() throws URISyntaxException{        
        ...
        try{
            for(File f : buscador.getArchivosEncontrados()){
                ...
                if(!Utils.esArchivoComprimido(f)){
    ...
    public void analizarArchivos(){
        Analizador analizador = new Analizador(archivos, false);
        
        lblZipPass.setText(analizador.getArchivosZipContraseña()+zipLabel);
        lblRarPass.setText(analizador.getArchivosRarContraseña()+rarLabel);
        lblInvalidos.setText(analizador.getArchivosInvalidos()+invalidosLabel);
        
        String f1 = analizador.getArchivosZipContraseña() == 0 ? "\n" : analizador.getArchivosZipContraseña() == 1 ? "1 tiene contraseña\n" : analizador.getArchivosZipContraseña()+" tienen contraseña\n";
        String f2 = analizador.getArchivosRarContraseña() == 0 ? "\n" : analizador.getArchivosRarContraseña() == 1 ? "1 tiene contraseña\n" : analizador.getArchivosRarContraseña()+" tienen contraseña\n";
        
        String analisis = "Total de archivos encontrados: "+analizador.getTodosLosArchivos()+"\n"
                + "Archivos comprimidos encontrados: "+analizador.getArchivosComprimidos()+"\n"
                + "Otros archivos encontrados: "+analizador.getArchivosNormales()+"\n"
                + "Archivos zip encontrados: "+analizador.getArchivosZip()+" | "+f1+""
                + "Archivos rar encontrados: "+analizador.getArchivosRar()+" | "+f2+""
                + "Archivos invalidos: "+analizador.getArchivosInvalidos()+"\n";
        
        consoleStatus.append(analisis);
        
        
        
        //lblOtrosArchivos.setText(analizador.getArchivosNormales()+otrosArchivosLabel);
    }
        ...
        public void propertyChange(PropertyChangeEvent evt) {
            if(evt.getPropertyName().equals("CheckStatusProperty")){
                ...
                if(evt.getNewValue().equals("START")){ //Comienza con la busqueda de los archivos
                    ...
                    consoleStatus.append("===== ANALIZANDO ARCHIVOS =====\n");
                    /*try {
                        //verificarArchivos();
                    } catch (URISyntaxException ex) {
                        Logger.getLogger(BusquedaArchivosDialog.class.getName()).log(Level.SEVERE, null, ex);
                    }*/
                    archivos = buscador.getArchivosEncontrados();
    ...
    */
    ...
    public String getRarLabel() {
        return rarLabel;
    }

    public JLabel getLblRarPass() {
        return lblRarPass;
    }

    public JLabel getLblZipPass() {
        return lblZipPass;
    }
    
    public JLabel getLblInvalidos(){
        return lblInvalidos;
    }
    ...
    private void initComponents() {
        ...
        consoleStatus.setFont(new java.awt.Font("Dialog", 0, 13)); // NOI18N
