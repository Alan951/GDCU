...
public class FiltroBuscadorView extends javax.swing.JDialog {
    ...
    public void initConfig(FiltroBusqueda filtro){
        ...
        if(filtro != null){
            ...
            if(filtro.getArchivoContraseñaFiltro() == 0){
                radioConySin.setSelected(true);
            }else if(filtro.getArchivoContraseñaFiltro() == 1){
    ...
    private void initComponents() {
        ...
        contraseñasGrupo = new javax.swing.ButtonGroup();
        ...
        radioConySin = new javax.swing.JRadioButton();
        radioCon = new javax.swing.JRadioButton();
        radioSin = new javax.swing.JRadioButton();
        ...
        panelTamañoArchivoLayout.setHorizontalGroup(
            ...
            .addGroup(panelTamañoArchivoLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelTamañoArchivoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtTamañoSup)
                    .addComponent(txtTamañoInf))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelTamañoArchivoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(CBUnidadInf, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(CBUnidadSup, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        contraseñasGrupo.add(radioConySin);
        radioConySin.setText("Incluir archivos con y sin contraseña");

        contraseñasGrupo.add(radioCon);
        radioCon.setText("Solo archivos con contraseña");

        contraseñasGrupo.add(radioSin);
        radioSin.setText("Solo archivos sin contraseña");
        ...
        panelOtrosLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelOtrosLayout.createSequentialGroup()
                ...
                .addGroup(panelOtrosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(radioSin)
                    .addComponent(radioCon)
                    .addComponent(radioConySin))
                .addGap(74, 74, 74))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(panelTamañoArchivo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(panelOtros, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 361, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        int contraseñaFiltro = -1;
        if(radioConySin.isSelected()){
            contraseñaFiltro = 0;
        }else if(radioCon.isSelected()){
            contraseñaFiltro = 1;
        }else if(radioSin.isSelected()){
            contraseñaFiltro = 2;
        }
        
        filtro = new FiltroBusqueda(inf, sup, dateInf, dateSup, contraseñaFiltro, incluirCarpetasOcultas, incluirArvosOcultos, extensiones);
    ...
    private javax.swing.ButtonGroup contraseñasGrupo;
    ...
    private javax.swing.JRadioButton radioConySin;
    private javax.swing.JRadioButton radioSin;
